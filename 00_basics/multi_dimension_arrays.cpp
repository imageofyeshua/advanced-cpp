...
int main(){
  ...
  //2D array
  //int packages [4][4] ; // 12 where we can store ints
  ...
  println("");
  println("Ommiting leftmost dimension for 2d array : ");
  ...
  int house_block2 [] [5] [4] { 	// Try to make the last dimension 5 and show that the compiler appends 2 zeros
    ...
    println("");
    println("Printing out 3d house_block array with defaulted elements : ");
