...
int main(){
  ...
  println("");
  println("Raw variable that can be modified : ");
  ...
  p_number1 = &number1;
  println("Pointer and value pointed to : both modifiable : ");
  println("p_number1 : {}", static_cast<void*>(p_number1));
  println("*p_number1 : {}", *p_number1);
  println("number1 : {}", number1);

  // Change the pointed to value through pointer
  println("");
  println("Modifying the value pointed to p_number1 through the pointer : ");
  *p_number1 = 432;
  println("p_number1 : {}", static_cast<void*>(p_number1));
  println("*p_number1 : {}", *p_number1);
  println("number1 : {}", number1);
  ...
  println("");
  println("Changing the pointer itself to make it point somewhere else");
  int number2 {56};
  p_number1 = &number2;
  println("p_number1 : {}", static_cast<void*>(p_number1));
  println("*p_number1 : {}", *p_number1);
  ...
  println("Pointer is modifiable , pointed to value is constant : ");
  ...
  println("*p_number3 : {}", *p_number3);
  println("number3 : {}", number3);

  println("");
  println("Changing the pointer itself to make it point somewhere else");
  println("Modifying the value pointed to by p_number3 through the pointer (Compile Error) : ");
  ...
  println("");
  println("Changing the address pointed to by p_number3 : ");
  int number4 {872};
  p_number3 = &number4;
  ...
  println("const keyword applies to a variable name : ");
  ...
  // *p_protected_var = 55;
  protected_var = 66;
  println("protected_var : {}", protected_var);
  println("p_protected_var : {}", static_cast<const void*>(p_protected_var));
  println("*p_protected_var : {}", *p_protected_var);
  println("");
  ...
  println("Pointer is constant, value pointed to is constant : ");
  println("*p_number5 : {}", *p_number5);
  println("number5 : {}", number5);

  // Can't modify the pointed to value through the pointer
  println("Changing value pointed to by p_number5 through the pointer (Compile Error) ");
  ...
  println("Changing the pointer p_number5 address itself (Compile Error) ");
  int number6 {333};
  ...
  println("Pointer is contant, pointed to value can change : ");

  int number7 {982};
  int * const p_number7 { &number7 };

  println("*p_number7 : {}", *p_number7);
  println("p_number7 : {}", static_cast<void*>(p_number7));

  println("Changing value pointed to through p_number7 pointer : ");

  *p_number7 = 456;
  println("The value pointed to by p_number7 now is : {}", *p_number7);

  int number8 {2928};
  println("Changing the address where p_number7 is pointing (Compile Error).");
  // p_number7 = &number8;
