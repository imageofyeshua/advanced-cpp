...
int main(){
  ...
  println("Unsafe printing of members : ");
  ...
  println("");
  println("Printing out character by character manually : ");
  ...
  println("");
  println("Printing out members1 (C-string literals) : ");
  ...
  println("");
  println("Prediction : {}", predictions[5]);
