...
int main(){
  ...
  //Showing the problem
  string str {"Hello Daniel!"};
  string str1 {str}; // Copy
  string str2 {str}; // Copy

  println("size of str : {}", sizeof(str));
  println("address of str : {}", static_cast<void*>(&str));
  println("address of str1 : {}", static_cast<void*>(&str1));
  println("address of str2 : {}", static_cast<void*>(&str2));
  ...
  println("Size of string_view : {}", sizeof(std::string_view));
  println("size of sv1 : {}", sizeof(sv1));
