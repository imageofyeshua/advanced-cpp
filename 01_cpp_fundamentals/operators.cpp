...
int main()
{
  ...
  cout << "Some Integer: " << someInteger << endl;
  cout << "Some Short: " << someShort << endl;
  cout << "Some Long: " << someLong << endl;
  cout << "Some Float: " << someFloat << endl;
  cout << "Some Double: " << someDouble << endl;
}
