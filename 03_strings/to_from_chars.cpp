...
int main()
{
...

  {
    ...
    if (result.ec == errc{}) { println("out buffer: {}", out); /* Conversion successful. */ }
  }

  {
    ...
    if (error == errc{}) { println("out buffer: {}", out); /* Conversion successful. */ }
  }

  {
    // Demonstrating perfect rount-tripping
    double value1{ 0.314 };
    string out(BufferSize, ' '); // A string of BufferSize space characters
